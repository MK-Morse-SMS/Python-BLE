...
class EventBroadcaster:
    ...
    def register_client(self) -> str:
        ...
        logger.info(f"Client {client_id} registered. Total clients: {len(self._active_clients)}")
        return client_id
    ...
    def unregister_client(self, client_id: str) -> None:
        ...
        logger.info(f"Client {client_id} unregistered. Remaining clients: {len(self._active_clients)}")
